    ...
    public function __invoke($_, array $args)
    {
        ...
        if ($actual_month != 1 && $actual_month != 2) {
            ...
            $ministred_actual_query =
                DB::table('threemonths_concepts_district_view')->select('ministered_lives')->where([
                    ['year', $year],
                    ['month', $actual_month],
        ...
        //MEMBRESIA ACTUAL
        $members_query = DB::table('threemonths_concepts_district_view')->select('current_membership')->where([
            ['year', $year],
            ['month', $actual_month],
            ['district_id', $district_id]
        ])->get();
        ...
        //DICIPULADO
        $candidates_query =
            DB::table('threemonths_concepts_district_view')->select('baptism_candidates')->where([
                ['year', $year],
                ['month', $actual_month],
                ['district_id', $district_id]
            ])->get();
        ...
        //NUEVOS CREYENTES
        $news_query =
            DB::table('threemonths_concepts_district_view')->select('new_believers_discipled')->where([
                ['year', $year],
                ['month', $actual_month],
                ['district_id', $district_id]
            ])->get();
