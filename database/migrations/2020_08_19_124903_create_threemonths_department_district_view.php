...
class CreateThreemonthsDepartmentDistrictView extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("DROP VIEW IF EXISTS threemonths_department_district_view");
        DB::statement(
            "CREATE VIEW threemonths_department_district_view AS
            SELECT
payrolls.id,
...
ORDER BY payrolls.id"
    ...
    {
        Schema::dropIfExists('threemonths_department_district_view');
    }
}
